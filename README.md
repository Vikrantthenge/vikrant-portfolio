...
Aviation operations and performance leader with 20+ years of experience across international airlines, aviation services, station management, flight operations, OCC support, ground handling and airport environments.

I combine operational leadership with applied analytics to build practical decision-support solutions for forecasting, workforce planning, KPI governance, operational risk monitoring and management reporting.
...
### ✈️ FlightPulse Delay Prediction

Flight-delay classification prototype developed using Python, machine learning and SHAP explainability.

The project was designed to move beyond a simple delayed or not-delayed prediction by identifying the operational variables contributing most strongly to each delay-risk result.
...
### 👥 CrewOps Workforce & Roster Planning

Scenario-based workforce and roster-planning solution designed to support staffing, capacity and resource-allocation decisions.
...
Dashboard prototype for monitoring operational-performance trends, identifying emerging risks and surfacing early-warning signals from operational data.
...
Locally deployed Generative AI assistant built using Ollama, Docker and Open WebUI.

The project explores how locally hosted language models can support operational-risk analysis, KPI assessment, recurring-pattern identification and executive-style management reporting without sending operational data to an external cloud service.
...
`Python` · `SQL` · `Power BI` · `Advanced Excel` · `Data Analysis` · `KPI Dashboards`

### Forecasting & Decision Support

`Demand Forecasting` · `Capacity Planning` · `Scenario Modelling` · `Machine Learning` · `SHAP Explainability`

### GenAI & Deployment

`Generative AI` · `Prompt Engineering` · `Ollama` · `Open WebUI` · `Docker` · `Streamlit` · `Git`

### Aviation Systems

`Jeppesen` · `Amadeus Altea` · `Navtech` · `AIMS / JOC Exposure` · `Flight Dispatch Systems`

---

## 🌐 Professional Background

More than 20 years of experience across international airlines, aviation services, flight operations, station management, OCC support, ground handling and airport operations.
...
Open to relevant aviation opportunities in the UAE, Qatar, Singapore and Europe.
...
<p align="left">
  <a href="https://github.com/Vikrantthenge">
    <img src="https://img.shields.io/badge/GitHub-View_Profile-24292F?style=for-the-badge&logo=github&logoColor=white" alt="GitHub">
  </a>
